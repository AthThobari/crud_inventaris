...
<body>
    ...
    <nav class="navbar navbar-light fixed-top bg-light shadow-sm">
        <div class="container-lg d-flex justify-content-between align-items-center">
            <a class="navbar-brand text-primary fw-bold fs-4" href="#"> <img src="{{ asset('img/airmu.jpg') }}"
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="{{ route('admin.index') }}">Data Barang</a></li>
                    <li><a class="dropdown-item" href="{{ route('admin.user.create') }}">Tambah Data Barang</a></li>
                    <hr color="black">
